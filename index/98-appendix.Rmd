...
landscape(knitr::kable(sv, "latex"))
...
```{r figurec3, out.width = "50%",echo=FALSE,fig.cap="Exploratory annual trends for the proportion of vegetation cover at certified and non-certified properties. The distribution of values is illustrated by the grey dots and the average annual value by the red and blue dots, for non-certified and certified farms, respectively. The yellow shade is delimited by the minimum and median certification dates.", fig.align='center'}
